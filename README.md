...
A real-time multiplayer game hub with Google login, a shared lobby, and live gameplay via SignalR. Currently features six games: **Tic Tac Toe**, **Yahtzee**, **Slots**, **Concentration Madness**, **Solitaire**, and **Chinese Checkers**.
...
- **Solitaire** — Klondike solitaire with single-player and multiplayer race modes.
